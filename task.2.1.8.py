...
def getclass():
    global class_name
    class_name = input("please enter the name of your class (class 1, class 2, or class 3): ")
    #while not(class_name=="class1" or class_name=="class2" or class_name=="class3"):
    #    class_name = input("please enter the name of your class (class1, class2, or class3: ")
getclass()
